using eSya.ApprovalProcess.WebAPI.Utility;
using eSya.ApprovalProcess.WebAPI.Filters;
using Microsoft.Extensions.Configuration;
using DL_ApprovalProcess = eSya.ApprovalProcess.DL.Entities;
using eSya.ApprovalProcess.IF;
using eSya.ApprovalProcess.DL.Repository;
using System.Globalization;
using eSya.ApprovalProcess.DL.Localization;
...
DL_ApprovalProcess.eSyaEnterprise._connString = builder.Configuration.GetConnectionString("dbConn_eSyaEnterprise");
